...
from src.boostface.component.identifier import Identifier, IdentifyWorker
from tests import generate_image2detect


@profile
def process_image(images: list[Image2Detect], identifier_manager: IdentifyManager):
    """
    ...
    with multiprocessing.Manager() as manager:
        ...
        try:
            ...
            fake_img: list[Image2Detect] = [
                generate_image2detect(size=(640, 640)) for _ in range(50)
            ]
